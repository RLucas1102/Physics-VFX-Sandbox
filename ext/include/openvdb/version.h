...
/// @hideinitializer
#define OPENVDB_LIBRARY_MAJOR_VERSION_NUMBER 13
/// @hideinitializer
...
/// @hideinitializer
#define OPENVDB_ABI_VERSION_NUMBER 13
#endif
...
/// @hideinitializer
#define OPENVDB_LIBRARY_VERSION_STRING "13.1.1"
...
/// (although the two are usually the same).
/// @hideinitializer
#define OPENVDB_LIBRARY_ABI_VERSION_STRING "13.1.1abi13"

/// @brief Library version number as a packed integer ("%02x%02x%04x", major, minor, patch)
/// @hideinitializer
#define OPENVDB_LIBRARY_VERSION_NUMBER 218169345
...
/// where X, Y and N are the major, minor and ABI version numbers, respectively.
    ...
    #define OPENVDB_VERSION_NAME v13_1
#else
    #define OPENVDB_VERSION_NAME v13_1abi13
#endif
...
/* Denotes whether Vec2, Vec3 and Vec4 less than and greater than operators are
  enabled. These will be removed in a future release, whereby this define will
  become defunct
*/
...
#define OPENVDB_X86_INSTRSET 0

// Alias to legacy x86 intrinsic macros where necessary
#ifndef OPENVDB_USE_SSE42
    #if OPENVDB_X86_INSTRSET >= 6
        #define OPENVDB_USE_SSE42
    #endif
#endif
#ifndef OPENVDB_USE_AVX
    #if OPENVDB_X86_INSTRSET >= 7
        #define OPENVDB_USE_AVX
    #endif
#endif
#endif

/// Denotes if OpenVDB was configured with -D OPENVDB_SIMD=AVX. Note that
/// absence of this define does *not* indicate that no AVX instructions were
/// used (i.e. -mavx could have been manually provided, or manual instruction
/// rolling could be present). This flag primarily indicates the desired ISA.
#ifndef OPENVDB_USE_AVX
/* #undef OPENVDB_USE_AVX */
#endif

/// Denotes if OpenVDB was configured with -D OPENVDB_SIMD=AVX|SSE42. Note that
/// absence of this define does *not* indicate that no SSE42 instructions were
/// used (i.e. -msse4.2 could have been manually provided, or manual instruction
/// rolling could be present). This flag primarily indicates the desired ISA.
#ifndef OPENVDB_USE_SSE42
/* #undef OPENVDB_USE_SSE42 */
#endif
...
#define OPENVDB_ALL_TREE_INSTANTIATE(Function)       \
    ...
    OPENVDB_INSTANTIATE Function(HalfTree); \
...
///////////////////////////////////////////////////////////////////////////////
    ...
    // it exists to propagate this message to downstream targets
            ...
            PRAGMA(message("NOTE: ABI = 14 is still in active development and has not been finalized, "
                "define OPENVDB_USE_FUTURE_ABI_14 to suppress this message"))
        #endif
    #else
...
enum {
    ...
    OPENVDB_FILE_VERSION_HALF_GRID = 225
};
