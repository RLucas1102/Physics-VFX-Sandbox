...
if len(sys.argv) > 1:
    if "-h" in sys.argv:
        ...
        print( "Wild cards may be used in the list." )
        print( "The output movie will be named \"test.mp4\"." )
        print( "Example:" )
        print( "\t./makemovie.py *.exr" )
        print( " " )
